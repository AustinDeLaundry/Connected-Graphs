/**************************************/
/* STUDENTS -                         */
/*   YOU MAY ONLY ADD TO THE PRIVATE  */
/*   PORTION OF THE INTERFACE FILE    */
/**************************************/
...
class Graph {
 ...
 public:
  ...
  /* GetNumEges() - get the number of edges
     Preconditions: none
 ...
 private:
  ...
  /* ADD ADDITIONAL CLASS VARIABLES HERE, IF NEEDED. */

  /* DECLARE CLASS HELPER FUNCTIONS HERE, IF NEEDED. */
